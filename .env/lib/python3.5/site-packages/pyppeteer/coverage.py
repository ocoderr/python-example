...
class JSCoverage(object):
    ...
    async def start(self, options: Dict=None, **kwargs: Any) -> None:
        ...
        self._eventListeners = [helper.addEventListener(self._client, 'Debugger.scriptParsed', (lambda e: asyncio.ensure_future(
...
class CSSCoverage(object):
    ...
    async def start(self, options: Dict=None, **kwargs: Any) -> None:
        ...
        self._eventListeners = [helper.addEventListener(self._client, 'CSS.styleSheetAdded', (lambda e: asyncio.ensure_future(
