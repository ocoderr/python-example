...
class Request(object):
    ...
    def __init__(self, client: CDPSession, requestId: Optional[str], interceptionId: str, allowInterception: bool, url: str, resourceType: str, payload: dict, frame: Optional[Frame]) -> None:
        self._client = client
...
class Response(object):
    ...
    def __init__(self, client: CDPSession, request: Request, status: int, headers: Dict[(str, str)]) -> None:
        self._client = client
...
def generateRequestHash(request: dict) -> str:
    ...
    if (not normalizedURL.startswith('data:')):
        ...
        for header in headers:
            ...
            header = header.lower()
            if ((header == 'accept') or (header == 'referer') or (header == 'x-devtools-emulate-network-conditions-client-id')):
                continue
