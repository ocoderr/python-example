...
class ExecutionContext(object):
    ...
    def __init__(self, client: CDPSession, contextPayload: Dict, objectHandleFactory: Any) -> None:
        self._client = client
    ...
    def _convertArgument(self, arg: Any) -> Dict:
        ...
        if objectHandle:
            ...
            if objectHandle._remoteObject.get('unserializableValue'):
                return {
                    'unserializableValue': objectHandle._remoteObject.get('unserializableValue'),
                }
